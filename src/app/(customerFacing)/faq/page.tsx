...
const FAQS = [
  ...
  { q: "Can I return shoes that don't fit?", a: "Yes — unworn shoes in original packaging can be returned within 30 days. Contact us at admin@example.com with your order number to start a return." },
  { q: "Are your products genuine?", a: "Absolutely. Saint Laurens Sporting Goods is an authorised dealer for all brands we stock, including Adidas, Nike, New Balance, Wilson, and Gryphon. Every product is 100% genuine." },
  { q: "Do you offer in-store fitting?", a: "Yes — our store offers expert shoe fitting Monday–Friday 8am–5pm and Saturday 8am–1pm. Our staff are experienced athletes who can advise on the right fit for your foot type and training style." },
  ...
  { q: "How do I contact you?", a: "Call us on 000 000 0000 (Mon–Fri 8am–5pm, Sat 8am–1pm) or email admin@example.com. We aim to respond to emails within one business day." },
]
...
export default function FAQPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      <p className="text-text-muted mb-10">Can't find your answer? <a href="mailto:admin@example.com" className="text-brand-blue hover:underline">Email us</a> or call 000 000 0000.</p>
