  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <h1 className="font-extrabold text-text-primary mb-2" style={{ fontSize: "clamp(24px,5vw,36px)" }}>
        About Saint Laurens Sporting Goods
      </h1>
      <p className="text-brand-blue font-semibold mb-8">Your trusted sports specialist</p>

      <div className="prose prose-sm max-w-none text-text-secondary space-y-5 leading-relaxed">
        <p>
          Saint Laurens Sporting Goods has been a trusted sports retailer for decades. We have built our reputation on
          genuine expert advice, authorised brand partnerships, and a genuine passion for sport.
        </p>
        <p>
        ...
        <p>
          We welcome walk-in customers for fitting appointments and expert shoe-fitting advice. Our store is open
          Monday–Friday 8am–5pm and Saturday 8am–1pm.
        </p>
        <p>
          <strong>Phone:</strong> <a href="tel:+10000000000" className="text-brand-blue hover:underline">000 000 0000</a><br />
          <strong>Email:</strong> <a href="mailto:admin@example.com" className="text-brand-blue hover:underline">admin@example.com</a>
        </p>
      </div>
