# Saint Laurens Sporting Goods — example.com

Next.js 15 ecommerce store for Saint Laurens Sporting Goods.
...
- [ ] Verify your Resend sending domain (orders@example.com)
